...
#########################################################################################################
        ...
        self.petInfoWidget = QtWidgets.QWidget(PetOwnerWindow)
    ...
    def retranslateUi(self, PetOwnerWindow):
        ...
        self.petOwnerTabs.setTabText(self.petOwnerTabs.indexOf(
            self.myPetsTab), _translate("PetOwnerWindow", "My Pets"))
        self.label.setText(_translate("PetOwnerWindow", "My Appointments"))
        self.petOwnerTabs.setTabText(self.petOwnerTabs.indexOf(
            self.appointmentBookTab), _translate("PetOwnerWindow", "Appointment Book"))
